...
photographers = [
    ...
    {"id": "p2", "name": "Sana Clickz", "skills": ["street", "Event"],"image": "sana.jpg"},
     {"id": "p3", "name": "Dev", "skills": ["Sport", "product"],"image": "Dev.jpg",},
    {"id": "p4", "name": "Siri", "skills": ["Wildlife", "trekking"],"image": "siri.jpg"},
   {"id": "p5", "name": "Ram", "skills": ["Adventure", "Nature"],"image": "ram.jpg"}
...
availability_data = {
    ...
    "p2": ["2025-06-19", "2025-06-22"],
     "p3": ["2025-06-20", "2025-06-23"],
    "p4": ["2025-06-20", "2025-06-23"],
    "p5": ["2025-06-20", "2025-06-23"]
